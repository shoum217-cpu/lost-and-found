      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
            Real-time updates regarding AI matches, claims, and ownership verifications.
          </p>
        </div>
